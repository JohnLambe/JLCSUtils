...
{
    //TODO: Optionally output a list of what is being registered.
                ...
                if (item.Attribute is DiRegisterTypeAttribute)
                {
                    if (item.Attribute.ForType != null)
                    {
                        if (item.Attribute.Name != null)
                            throw new DependencyInjectionException("DiRegisterTypeAttribute: Specifying both Name and ForType is invalid");
