...
namespace JohnLambe.Util.Documentation
{
    ...
    /// </summary>
    public abstract class DiagramAttributeBase : Attribute
    {
        /// <summary>
    ...
    public class TypeDiagramAttribute : DiagramAttributeBase
    {
        /// <summary>
    ...
    /// </summary>
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true, Inherited = true)]
    public class MemberDiagramAttribute : DiagramAttributeBase
    {
        /// <summary>
