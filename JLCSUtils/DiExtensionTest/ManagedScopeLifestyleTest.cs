...
{
    [TestClass]
    public class ManagedScopeLifestyleTest
    {
        [TestMethod]
        ...
        [TestMethod]
        public void ManagedScopeLifeCycleTest1()
        {
            SetupDi();
            ...
            var scope1 = ScopeManager.StartScope();
            var scope1Instance = _container.GetInstance<ITestClass1>();  // different instance to 'root'
            var scope1Instance1 = _container.GetInstance<ITestClass1>();   // multiple calls in this scope give the same instance as each other
            ...
            ScopeManager.StartScope(scope1);
            var scope1Instance2 = _container.GetInstance<ITestClass1>();  // different instance to 'root'
            ScopeManager.EndScope();

            Assert.AreEqual(scope1Instance, scope1Instance2);    // same instance as before
        }
        ...
        public void SetupDi()
        {
            ...
            ScopeManager = new SiManagedScopeLifestyleManager(_container);
        ...
        public SiManagedScopeLifestyleManager ScopeManager;
