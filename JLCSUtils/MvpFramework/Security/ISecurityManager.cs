...
namespace MvpFramework.Security
{
    ...
    {
        public SecurityResult(bool allowed, string message)
        {
        ...
        /// </summary>
        public static SecurityResult Success = new SecurityResult(true, "Access allowed");

        public static SecurityResult Denied = new SecurityResult(false, "Access denied"); 
    }
