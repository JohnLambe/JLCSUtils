namespace MvpFramework.Dialog
{
    ...
    /// <para>
    /// This system (<see cref="MessageDialogType"/>) encourages dialogs that have a visual indication (icon, color, style, dialog box shape etc.)
    ...
    /// A color (or color scheme) or other style (maybe a differently-shaped dialog - with a diagonal cutout in a corner, etc.)
    ...
    /// an indication of the dialog type (warning, information, etc.), e.g. by overlaying an icon or by a color scheme for each type.
    /// </para>
    /// </para>
    /// 
    /// </summary>
